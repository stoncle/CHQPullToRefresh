...
//        SpiralPullToRefreshView *view = [[SpiralPullToRefreshView alloc] initWithFrame:CGRectMake(0, -SpiralPullToRefreshViewHeight, self.bounds.size.width, SpiralPullToRefreshViewHeight)];
        ...
        CHQSpiralRefreshView *view = [[CHQSpiralRefreshView alloc] initWithFrame:CGRectMake(0, -SpiralPullToRefreshViewHeight, self.bounds.size.width, SpiralPullToRefreshViewHeight)];
...
- (void)triggerPullToRefresh {
    self.pullToRefreshController.state = SpiralPullToRefreshStateTriggered;
    [self.pullToRefreshController startAnimating];
}

- (void)setPullToRefreshController:(CHQPullToRefreshView *)pullToRefreshView {
...
- (CHQPullToRefreshView *)pullToRefreshController {
